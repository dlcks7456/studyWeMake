CREATE TABLE "todos" (
	"todo_id" bigint PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "todos_todo_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854775807 START WITH 1 CACHE 1),
	"title" text NOT NULL,
