...
CREATE TABLE "message_room" (
	"message_room_id" bigint PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "message_room_message_room_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854775807 START WITH 1 CACHE 1),
...
--> statement-breakpoint
ALTER TABLE "message_room_members" ADD CONSTRAINT "message_room_members_message_room_id_message_room_message_room_id_fk" FOREIGN KEY ("message_room_id") REFERENCES "public"."message_room"("message_room_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "messages" ADD CONSTRAINT "messages_message_room_id_message_room_message_room_id_fk" FOREIGN KEY ("message_room_id") REFERENCES "public"."message_room"("message_room_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
