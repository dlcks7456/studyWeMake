-- CREATE TYPE "public"."job_type" AS ENUM('full-time', 'part-time', 'contract', 'freelance', 'internship');--> statement-breakpoint
...
CREATE TYPE "public"."product_stages" AS ENUM('idea', 'prototype', 'mvp', 'growth', 'mature');--> statement-breakpoint
